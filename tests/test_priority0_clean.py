...
def test_session_state():
    ...
    assert empty_prompt == ">>> "
    print("  [OK] Empty prompt generated correctly")
    ...
    print("  [OK] Filtered prompt generated correctly")
    ...
    print("  [OK] Session state updates correctly")
...
def test_analysis_counting():
    ...
    print("  [OK] Analysis counting returns correct structure")
    ...
    if counts['details']:
        ...
        print("  [OK] Analysis details contain required fields")

    print("[PASS] Analysis Counting Logic\n")
    return True
...
def test_plot_confirmation():
    ...
    print("  [OK] Plot command detection working correctly")
    ...
    print("  [OK] Entity extraction working correctly")
    ...
    print("  [OK] Preview data generation working correctly")

    print("[PASS] Plot Confirmation\n")
    return True
...
def test_command_parsing():
    ...
    print("  [OK] Session commands parsed correctly")
    ...
    print("  [OK] Enhanced stats commands parsed correctly")

    print("[PASS] Enhanced Command Parsing\n")
    return True
